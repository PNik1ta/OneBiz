...
@Component({
  ...
  templateUrl: './create-booking-review-dialog.component.html',
  styleUrl: './create-booking-review-dialog.component.scss'
})
export class CreateBookingReviewDialogComponent {
  form: FormGroup;
  rating = 0;
  hoverRating = 0;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateBookingReviewDialogComponent>,
  ...
  submit(): void {
    ...
    const dto: ICreateReviewDto = {
      booking_business_id: this.bookingId,
      type: EReviewType.BOOKING,
